...
const alphabetize = (arr) => {
  ...
  let alphabetReturn = arr.sort()
  return alphabetReturn;
};
...
const sortPeopleBetter = (arr) => {
  arr.sort(function (a, b) {
    let one = a.lastName.toLowerCase();
    let two = b.lastName.toLowerCase();
    let three = a.firstName.toLowerCase();
    let four = b.firstName.toLowerCase();
    // let alphabetReturn = arr.sort()

    if (one === two && three === four && a.age < b.age) {
      return -1;
    } else if (one === two && three === four && a.age > b.age) {
      return 1;
